...
const Whyneedus = () => {
  return (
    <div className='py-8 lg:py-24 xl:py-32 2xl:py-40 px-6 md:px-8 lg:px-20 xl:px-32 2xl:px-80 overflow-x-hidden'>
      <div className='flex flex-col lg:flex-row gap-16 items-center'>

        {/* Content First - so it appears above image on mobile */}
        <motion.div
        ...
        >
            <p className='text-[#ada282]'
             style={{ fontFamily: '"Open Sans", sans-serif' }}
            >
                We Are Expert
            </p>
          <h1 className='text-[33px] md:text-4xl lg:text-[42px] xl:text-[52px] 2xl:text-[72px] text-[#282e3f]'
          style={{ fontFamily: '"Playfair Display", serif' }}
          >
            Why You Need Us
          </h1>

          <p className='mt-5 md:mt-6 lg:mt-8 xl:mt-10 2xl:mt-12 text-[#666] text-[15px] md:text-[16px] lg:text-[17px] xl:text-xl 2xl:text-[28px] leading-relaxed 2xl:leading-loose'
           style={{ fontFamily: '"Open Sans", sans-serif' }}
          >
          ...
          <motion.button
            className='font-medium text-[15px] md:text-[16px] lg:text-[17px] xl:text-xl 2xl:text-[24px] bg-[#c0b596] hover:bg-[#b3a785] text-white mt-5 md:mt-6 lg:mt-8 xl:mt-10 2xl:mt-12 py-3 px-6 md:py-3.5 md:px-7 lg:py-4 lg:px-8 xl:py-5 xl:px-10 2xl:py-6 2xl:px-12 transition-colors duration-300'
            style={{ fontFamily: '"Open Sans", sans-serif' }}
            variants={fadeUp}
            custom={0}
            initial="hidden"
        ...
        {/* Image Below (in code) so it's below on mobile, left on large */}
        <motion.div
